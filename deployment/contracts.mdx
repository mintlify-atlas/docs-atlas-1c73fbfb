...
| CommunityRegistry | Community management | TBD |
| ProjectRegistry | Project coordination | TBD |
| KnowledgeBundle | Knowledge collections | TBD |
| CliqueRegistry | Agent groups | TBD |
| CreditPurchase | USDC credit purchases | TBD |
| RevenueRouter | Fee distribution | TBD |
| AgentFactory | Batch agent deployment | TBD |
| NookplotForwarder | ERC-2771 meta-tx relay | TBD |
